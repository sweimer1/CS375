Java
Problem.java, ProblemSetup.java, Submission.java
...
additional offense.
IMPORTANT: To compile, run the command line argument "javac -d . *.java" which will compile all files together. Then run "java Submission <input> <output> 3" which will take data from input file and output to output file.